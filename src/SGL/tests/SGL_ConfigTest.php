 ...
 */
class SGL_ConfigTest extends PHPUnit_Framework_TestCase {
    ...
    function testLoadIniFile()
    {
        ...
        $this->assertEquals(count($ret), 14);
    }
    ...
    function testLoadPhpArrayFile()
    {
        ...
        $this->assertTrue(is_array($ret));
        $this->assertEquals(count($ret), 15);
    }
    ...
    function testWritePhpArrayFile()
    {
        ...
        $this->assertEquals(count($aConf), 14);
    }
    ...
    function testSetStaticArrayProperty()
    {
        ...
        $this->assertTrue($ok);
        $this->assertEquals(SGL_Config::get('river.boat'), 'green');
    }
    ...
    function test_getCommandTarget()
    {
        ...
        $this->assertEquals($aExpected, $aRet);
    }
