 ...
 */
class SGL_UrlTest extends PHPUnit_Framework_TestCase {
...
//        $ok = $url->init();
    ...
    function xtestCorrerctSefResultsWithMultipleStrats()
    {
        ...
        //  assert expected values present
        $this->assertEquals($ret['moduleName'], 'default');
        $this->assertEquals($ret['managerName'], 'bug');
    }
    ...
    function xtestCorrerctAliasResultsWithMultipleStrats()
    {
        ...
        //  assert expected values present
        $this->assertEquals($ret['moduleName'], 'default');
        $this->assertEquals($ret['managerName'], 'default');
    }
    ...
    function testGetStrategiesFingerprint()
    {
        ...
        $this->assertEquals(strtolower($fingerprint), $target); // added strtolower for php4 compat
    }
}
